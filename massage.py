...
class comment:
    ...
    def massages(self):
        ...
        for a in account:
            ...
            for m in massages:
                massages_list_min.append(m.text)
            list_massags.append(massages_list_min)
            print(list_massags)
            time.sleep(4)    

        #     num=0
        #     for u in list_username:
        #         dict_show[u]=list_massags[num]
        #         num+=1
        #         # for m in range(len(list_username)):
        #         #     dict_show[u]=list_massags
        #     print(dict_show)
